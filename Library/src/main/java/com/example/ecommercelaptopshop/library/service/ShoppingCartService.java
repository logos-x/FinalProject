...
import com.example.ecommercelaptopshop.library.dto.CartItemDto;
import com.example.ecommercelaptopshop.library.dto.ProductDto;
import com.example.ecommercelaptopshop.library.dto.ShoppingCartDto;
...
import com.example.ecommercelaptopshop.library.repository.CartItemRepository;
import com.example.ecommercelaptopshop.library.repository.ShoppingCartRepository;
...
public class ShoppingCartService {
    ...
    public ShoppingCart addItemToCart(ProductDto productDto, int quantity, String username) {
        ...
        double unitPrice = productDto.getOriginalPrice();
    ...
    private Product transfer(ProductDto productDto) {
        ...
        product.set_deleted(productDto.is_activated());
