package com.example.ecommercelaptopshop.library.utils;

import com.example.ecommercelaptopshop.library.entity.User;
import com.example.ecommercelaptopshop.library.service.CustomUserDetailService;
import com.example.ecommercelaptopshop.library.service.UserService;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws
        ...
        return http.csrf(csrf -> csrf.disable())
                .authorizeHttpRequests(auth -> auth
                                .requestMatchers("/css/**", "/js/**", "/", "/error", "/images/**")
                                .permitAll()
